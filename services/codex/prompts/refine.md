...
- Preserve intentional Japanese address register and honorifics when they are already present in the Simplified Chinese subtitles. Do not remove or flatten suffixes such as `桑`, `酱`, `君`, `大人`, `前辈`, or `后辈` just to make the line sound more localized. Keep the speaker's polite/plain register contrast through word choice, but treat this as a preservation rule, not a reason to over-edit otherwise natural lines.
